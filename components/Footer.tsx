    ...
    <footer className="bg-[#101832] text-white border-t border-gray-800 pt-16 pb-12 mt-auto">
      <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-12">
          ...
          <div className="lg:col-span-4 flex flex-col items-start gap-5">
            ...
            <Link href="/" className="flex items-center gap-2.5 group select-none">
              <div className="relative flex items-center justify-center">
                <span className="w-3.5 h-3.5 rounded-full bg-[#7c35ed] shadow-[0_0_14px_rgba(124,58,237,0.9)]" />
                <span className="absolute w-5 h-5 rounded-full bg-[#7c35ed]/30 animate-pulse" />
              </div>
            ...
            <Link
              href="/book-a-call"
              className="mt-2 bg-[#7c35ed] hover:bg-[#6d28d9] text-white font-bold text-sm px-6 py-3 rounded-full shadow-[0_8px_20px_rgba(124,58,237,0.3)] transition-all flex items-center gap-2 group"
            >
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-400">
          <p>© 2026 The System Digital. All rights reserved.</p>

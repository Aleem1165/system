...
export const metadata: Metadata = {
  title: "Google Ads | System Digital",
  description: "Capture high-intent homeowners actively searching for your services.",
};

export default function google_adsPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 pt-32 sm:pt-36 pb-20 text-center flex flex-col items-center">
      ...
      <p className="text-lg sm:text-xl text-[#566073] max-w-2xl leading-relaxed mb-10">
        Capture high-intent homeowners actively searching for your services.
      </p>

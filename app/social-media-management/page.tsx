...
export const metadata: Metadata = {
  title: "Social Media Management | System Digital",
  description: "Consistent social media content and management for local contractors.",
};

export default function social_media_managementPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 pt-32 sm:pt-36 pb-20 text-center flex flex-col items-center">
      ...
      <p className="text-lg sm:text-xl text-[#566073] max-w-2xl leading-relaxed mb-10">
        Consistent social media content and management for local contractors.
      </p>

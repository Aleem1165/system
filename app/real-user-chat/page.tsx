      ...
      <section className="pt-28 sm:pt-36 pb-10 sm:pb-14 relative overflow-hidden bg-gradient-to-b from-[#fff8f2] via-white to-white">
        ...
        <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-12 relative z-10">
          ...
          {/* <div className="flex flex-wrap items-center gap-2 text-xs sm:text-sm font-semibold text-[#566073] mb-6">
            ...
            <span>/</span>
            <span className="text-[#ea580c] font-bold">Real User 24/7 Chat</span>
          </div> */}
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-7 border border-gray-200/80 shadow-2xl relative overflow-hidden">
                ...
                <div className="flex items-center justify-between pb-4 border-b border-gray-100 mb-4">
                  <div className="flex items-center gap-3">
                    <div className="relative w-10 h-10 rounded-full bg-gradient-to-tr from-[#ff7a1a] to-[#ea580c] flex items-center justify-center text-white font-bold text-sm shadow-md">
                      <span>JD</span>
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] uppercase font-bold text-[#ea580c] bg-[#fff7ed] px-2 py-0.5 rounded-full border border-[#ff7a1a]/15">
                          Live Specialist
                        </span>
                      </div>
                ...
                <div className="flex flex-col gap-3 py-2 text-xs sm:text-sm">
                  ...
                  <div className="flex flex-col items-end">
                    <div className="bg-[#ff7a1a] text-white p-3.5 rounded-2xl rounded-tr-xs max-w-[85%] shadow-sm">
                  ...
                  <div className="flex flex-col items-start">
                    <div className="bg-[#fff7ed] text-[#101832] p-3.5 rounded-2xl rounded-tl-xs max-w-[85%] border border-[#ff7a1a]/10 shadow-xs">
                ...
                <div className="mt-4 pt-3 border-t border-gray-100 flex items-center gap-2">
                  ...
                  <div className="w-9 h-9 rounded-full bg-[#ff7a1a] text-white flex items-center justify-center text-xs shadow-md">
                    ↑
                  </div>
                </div>
              </div>

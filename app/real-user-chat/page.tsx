...
export const metadata: Metadata = {
  title: "Real User 24/7 Chat | System Digital",
  description: "Live human chat agents answering questions around the clock.",
};

export default function real_user_chatPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 pt-32 sm:pt-36 pb-20 text-center flex flex-col items-center">
      ...
      <p className="text-lg sm:text-xl text-[#566073] max-w-2xl leading-relaxed mb-10">
        Live human chat agents answering questions around the clock.
      </p>

...
export const metadata: Metadata = {
  title: "Automated Follow Up | System Digital",
  description: "Follow up with leads automatically so jobs never slip away.",
};

export default function automated_follow_upPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 pt-32 sm:pt-36 pb-20 text-center flex flex-col items-center">
      ...
      <p className="text-lg sm:text-xl text-[#566073] max-w-2xl leading-relaxed mb-10">
        Follow up with leads automatically so jobs never slip away.
      </p>

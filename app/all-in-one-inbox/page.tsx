...
export const metadata: Metadata = {
  title: "Mobile App & Inbox | System Digital",
  description: "One unified place for all texts, calls, and customer messages.",
};

export default function all_in_one_inboxPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 pt-32 sm:pt-36 pb-20 text-center flex flex-col items-center">
      ...
      <p className="text-lg sm:text-xl text-[#566073] max-w-2xl leading-relaxed mb-10">
        One unified place for all texts, calls, and customer messages.
      </p>

...
export const metadata: Metadata = {
  title: "5-Star Review Funnel | System Digital",
  description: "Get more 5-star Google reviews from satisfied homeowners automatically.",
};

export default function review_funnelPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 pt-32 sm:pt-36 pb-20 text-center flex flex-col items-center">
      ...
      <p className="text-lg sm:text-xl text-[#566073] max-w-2xl leading-relaxed mb-10">
        Get more 5-star Google reviews from satisfied homeowners automatically.
      </p>

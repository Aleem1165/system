...
export const metadata: Metadata = {
  title: "TikTok Ads | System Digital",
  description: "Reach homeowners with engaging short-form video advertising.",
};

export default function tiktok_adsPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 pt-32 sm:pt-36 pb-20 text-center flex flex-col items-center">
      ...
      <p className="text-lg sm:text-xl text-[#566073] max-w-2xl leading-relaxed mb-10">
        Reach homeowners with engaging short-form video advertising.
      </p>

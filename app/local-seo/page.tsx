...
export const metadata: Metadata = {
  title: "Local SEO | System Digital",
  description: "Rank at the top of local Google searches in your service area.",
};

export default function local_seoPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 pt-32 sm:pt-36 pb-20 text-center flex flex-col items-center">
      ...
      <p className="text-lg sm:text-xl text-[#566073] max-w-2xl leading-relaxed mb-10">
        Rank at the top of local Google searches in your service area.
      </p>

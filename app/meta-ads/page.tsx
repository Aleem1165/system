...
export const metadata: Metadata = {
  title: "Meta Ads (Facebook & Instagram) | System Digital",
  description: "Targeted Facebook and Instagram advertising campaigns that produce leads.",
};

export default function meta_adsPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 pt-32 sm:pt-36 pb-20 text-center flex flex-col items-center">
      ...
      <p className="text-lg sm:text-xl text-[#566073] max-w-2xl leading-relaxed mb-10">
        Targeted Facebook and Instagram advertising campaigns that produce leads.
      </p>

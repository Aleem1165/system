...
export const metadata: Metadata = {
  title: "Business Phone | System Digital",
  description: "Separate work calls from personal calls on your smartphone.",
};

export default function business_phonePage() {
  return (
    <div className="max-w-4xl mx-auto px-6 pt-32 sm:pt-36 pb-20 text-center flex flex-col items-center">
      ...
      <p className="text-lg sm:text-xl text-[#566073] max-w-2xl leading-relaxed mb-10">
        Separate work calls from personal calls on your smartphone.
      </p>

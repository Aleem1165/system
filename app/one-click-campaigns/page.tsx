...
export const metadata: Metadata = {
  title: "One-Click Campaigns | System Digital",
  description: "Customer updates and reactivation campaigns in just one click.",
};

export default function one_click_campaignsPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 pt-32 sm:pt-36 pb-20 text-center flex flex-col items-center">
      ...
      <p className="text-lg sm:text-xl text-[#566073] max-w-2xl leading-relaxed mb-10">
        Customer updates and reactivation campaigns in just one click.
      </p>

      ...
      <section className="relative pt-32 sm:pt-36 pb-12 sm:pb-14 bg-[#faf8fd]">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <Link
              href="/book-a-call"
              className="bg-[#7c35ed] hover:bg-[#6d28d9] text-white font-bold text-sm px-8 py-4 rounded-full shadow-[0_10px_24px_rgba(124,58,237,0.3)] hover:shadow-[0_14px_30px_rgba(124,58,237,0.45)] transition-all flex items-center gap-2 group cursor-pointer"
            >
            ...
            <a
              href="#trades-grid"
              className="px-6 py-4 rounded-full border border-gray-200 text-sm font-bold text-[#101832] hover:border-[#7c35ed] hover:text-[#7c35ed] transition-colors cursor-pointer"
            >
          ...
          <div className="rounded-3xl bg-gradient-to-br from-[#101832] via-[#161f3a] to-[#251540] text-white p-8 sm:p-12 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                <Link
                  href="/book-a-call"
                  className="bg-[#7c35ed] hover:bg-[#6d28d9] text-white font-bold text-sm px-8 py-4 rounded-full shadow-lg transition-all flex items-center gap-2 group"
                >

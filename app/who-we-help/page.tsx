...
export const metadata: Metadata = {
  title: "Who We Help | System Digital",
  description: "Tailored website and marketing solutions for local trades & contractors.",
};

export default function who_we_helpPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 pt-32 sm:pt-36 pb-20 text-center flex flex-col items-center">
      ...
      <p className="text-lg sm:text-xl text-[#566073] max-w-2xl leading-relaxed mb-10">
        Tailored website and marketing solutions for local trades & contractors.
      </p>

...
export const metadata: Metadata = {
  title: "Missed Call Text Back | System Digital",
  description: "Automatically text missed calls and save lost leads immediately.",
};

export default function missed_call_text_backPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 pt-32 sm:pt-36 pb-20 text-center flex flex-col items-center">
      ...
      <p className="text-lg sm:text-xl text-[#566073] max-w-2xl leading-relaxed mb-10">
        Automatically text missed calls and save lost leads immediately.
      </p>

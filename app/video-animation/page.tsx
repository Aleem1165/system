...
export const metadata: Metadata = {
  title: "Video Animation | System Digital",
  description: "High-impact video animations explaining your contractor services.",
};

export default function video_animationPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 pt-32 sm:pt-36 pb-20 text-center flex flex-col items-center">
      ...
      <p className="text-lg sm:text-xl text-[#566073] max-w-2xl leading-relaxed mb-10">
        High-impact video animations explaining your contractor services.
      </p>

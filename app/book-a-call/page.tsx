...
export const metadata: Metadata = {
  title: "Book a Call | System Digital",
  description: "Schedule a free 1-on-1 strategy call to grow your contractor business.",
};

export default function book_a_callPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 pt-32 sm:pt-36 pb-20 text-center flex flex-col items-center">
      ...
      <p className="text-lg sm:text-xl text-[#566073] max-w-2xl leading-relaxed mb-10">
        Schedule a free 1-on-1 strategy call to grow your contractor business.
      </p>

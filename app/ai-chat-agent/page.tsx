      ...
      <section className="pt-28 sm:pt-36 pb-16 sm:pb-24 relative overflow-hidden bg-gradient-to-b from-[#faf8fd] via-white to-white">
        ...
        <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-12 relative z-10">
          ...
          <div className="flex flex-wrap items-center gap-2 text-xs sm:text-sm font-semibold text-[#566073] mb-6">
            ...
            <span>/</span>
            <span className="text-[#7c35ed] font-bold">Live AI Chat 24/7</span>
          </div>
        ...
        <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
            {pillars.map((p, idx) => (
              <div
                key={idx}
                className="bg-white rounded-3xl p-8 sm:p-10 border border-gray-200/80 shadow-[0_8px_24px_rgba(0,0,0,0.04)] hover:shadow-[0_16px_36px_rgba(124,58,237,0.1)] hover:border-[#7c35ed]/30 transition-all duration-300 flex flex-col justify-between group"
              >
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <div className="w-12 h-12 rounded-2xl bg-[#f5f3ff] border border-[#7c35ed]/15 flex items-center justify-center group-hover:scale-105 group-hover:bg-[#7c35ed] group-hover:text-white transition-all">
                      {p.icon}
                    </div>
                    <span className="text-2xl sm:text-3xl font-black text-gray-200 group-hover:text-[#7c35ed]/25 transition-colors">
                      {p.num}
                    </span>
                  </div>
                  ...
                  <ul className="space-y-2.5">
                    {p.points.map((pt, pIdx) => (
                      <li key={pIdx} className="flex items-start gap-2.5 text-xs sm:text-sm text-[#566073]">
                        <span className="w-4 h-4 rounded-full bg-[#7c35ed]/10 text-[#7c35ed] font-bold flex items-center justify-center flex-shrink-0 mt-0.5 text-xs">
                          ✓
                        </span>
                        <span>{pt}</span>
                      </li>
        ...
        <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {steps.map((st, sIdx) => (
              <div
                key={sIdx}
                className="relative bg-[#faf8fd] rounded-3xl p-8 border border-gray-200/70 hover:border-[#7c35ed]/30 hover:shadow-lg transition-all flex flex-col justify-between"
              >
                <div>
                  <span className="inline-block px-3 py-1 rounded-full bg-[#7c35ed]/10 text-[#7c35ed] text-xs font-bold mb-4">
                    Step {st.step}
                  </span>

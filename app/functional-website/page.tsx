...
export default function FunctionalWebsitePage() {
  ...
  return (
    <div className="w-full bg-white text-[#101832] overflow-hidden">
      ...
      {/* ========================================================================= */}
      <section className="relative pt-32 sm:pt-36 pb-10 sm:pb-14 overflow-hidden bg-gradient-to-b from-[#fff8f2] via-white to-white">
        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-8">
          ...
          {/* <div className="flex flex-wrap items-center gap-2 text-xs sm:text-sm font-semibold text-[#566073] mb-6">
            ...
            <span>/</span>
            <span className="text-[#ea580c] font-bold">Functional Website</span>
          </div> */}
      ...
      {/* ========================================================================= */}
      {/* 3. ARCHITECTURE HIGHLIGHTS (EVERYTHING INCLUDED) (COMMENTED OUT) */}
      {/* ========================================================================= */}
